#ifndef MATLAB_TOOLS_H_
#define MATLAB_TOOLS_H_

/*
 * linspace.
 * https://gist.github.com/jmbr/2375233
 */
...
/*
 * Simple least-squares polynomial fit routine.
...
int polyfit(const double* const dependentValues,
            ...
            unsigned int order, double* coefficients) {
  // Declarations...
  // ----------------------------------
  enum { maxOrder = 5 };
